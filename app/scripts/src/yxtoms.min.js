...
angular.module("mainApp",["angular-loading-bar","infinite-scroll","pasvaz.bindonce","ngAnimate","routeApp","yxt.controller","yxt.service","factoryApp","filterApp","directivesApp","ui.athena"]),angular.module("yxt.service",["s.common","s.home","s.clue","s.business","s.contract","s.market","s.team","s.data"]),angular.module("yxt.controller",["c.common","c.home","c.clue","c.business","c.contract","c.market","c.team","c.data"]);
function setCookie(cname,cvalue){document.cookie=cname+"="+cvalue+";"}function getCookie(cname){var endOfCookie,result=null,myCookie=""+document.cookie+";",searchName=""+cname+"=",startOfCookie=myCookie.indexOf(searchName);return-1!=startOfCookie&&(startOfCookie+=searchName.length,endOfCookie=myCookie.indexOf(";",startOfCookie),result=myCookie.substring(startOfCookie,endOfCookie)),result}function clearCookie(name){setCookie(name,"")}function getLocalStorage(key){var value;try{localStorage.setItem("TestKey","123"),value=localStorage.getItem(key)}catch(e){value=getCookie(key)}return value}function setLocalStorage(key,value){try{localStorage.setItem(key,value)}catch(e){setCookie(key,value)}}function getCode(){var str=window.location.search;return str.replace(/(\?code=)|(&state=STATE)/g,"")}function setToken(){var t=window.y_bridge_public.token;t&&null!=t&&setLocalStorage("token",t)}function dialog(txt){$(".dialog-tip").text(txt),$(".dialog").css("display","-webkit-box")}angular.isNullOrEmpty=function(t){return null==t||""==t},Date.prototype.Format=function(fmt){var o={"M+":this.getMonth()+1,"d+":this.getDate(),"H+":this.getHours(),"m+":this.getMinutes(),"s+":this.getSeconds(),"q+":Math.floor((this.getMonth()+3)/3),S:this.getMilliseconds()};/(y+)/.test(fmt)&&(fmt=fmt.replace(RegExp.$1,(this.getFullYear()+"").substr(4-RegExp.$1.length)));for(var k in o)new RegExp("("+k+")").test(fmt)&&(fmt=fmt.replace(RegExp.$1,1==RegExp.$1.length?o[k]:("00"+o[k]).substr((""+o[k]).length)));return fmt};var BASE_URL="http://api.oms.yxt.com/v1/",COM_URL="http://api.component.yxt.com/v1/",LOG_URL="http://api.usercenter.yxt.com/v1/",APP_VERSION=angular.element(document.getElementsByTagName("html")).attr("data-ver"),ua=navigator.userAgent.toLowerCase();window.y_bridge_public={platform:null,isY:!1,deviceId:"",version:0,client:null,orgid:"",userid:"",token:"",isNavbarHidden:!0,isToolbarHidden:!1,isGetClientInfo:!1,memberId:null,memberInfoCBObj:null,NaEptStr:function(a){return!!("string"==typeof a&&a.length>0)},NaEptFun:function(a){return!("function"!=typeof a)},NaEptObj:function(a){if(null==a)return!1;if(a.length>0)return!0;if(0===a.length)return!1;for(var b in a)if(hasOwnProperty.call(a,b))return!0;return!1},stringifyAndEncode:function(a){return"string"==typeof a||this.NaEptObj(a)?encodeURIComponent(JSON.stringify(a)):""},decodeAndParse:function(a){return this.NaEptStr(a)?JSON.parse(decodeURIComponent(a)):{}},buildParamString:function(a,b,c){var d={};return d.param=a||null,d.CBPluginName=b||"",d.CBTagName="",d.token=window.y_bridge_public.token||"",this.NaEptFun(c)&&(window[d.CBPluginName]=c),JSON.stringify(d)},ntvCB:function(a){if(a=a||"",this.NaEptStr(a)){var b=this.decodeAndParse(a),c=b.pluginname,e=(b.tagname,b.param||{});if(window[c])return window[c](e);throw"回调web出错!不存在回调的方法"}},loadURL:function(a){if(window.y_bridge_public.isY&&"android"==window.y_bridge_public.client&&window.y_bridge_public.version>=10025)return void prompt(a);var b=document.createElement("iframe"),c=document.body||document.documentElement;b.style.display="none",b.setAttribute("src",a),c.appendChild(b),setTimeout(function(){b.parentNode.removeChild(b),b=null},200),console.log(decodeURIComponent(a))},isAppVersionGreatThan:function(a){var b=0;if(/yunxuetang/.test(ua)){var c=ua.split("/"),d=c.length,e=c[d-1],e=e.split(".");2==e.length?e.push(0):b=parseInt(e.join(""))}return b>=a},init:function(){var i=window.navigator.userAgent.toLowerCase(),j=window.navigator.userAgent;i.indexOf("iphone")>0?this.client="iphone":i.indexOf("ipad")>0?this.client="ipad":i.indexOf("android")>0?this.client="android":this.client="pc or other",console.log("user agent:"+i),console.log("client is:",this.client);var arr=document.cookie.match(new RegExp("(^| )yxt.web.usertokencookiename=([^;]*)(;|$)"));if(null!=arr?(this.token=unescape(arr[2]),console.log("token:"+this.token)):console.log("notoken"),this.isY=i.indexOf("yunxuetang")>0,this.isY){var tmp=i.match(new RegExp("yunxuetang/([0-9]+)"));tmp&&2==tmp.length&&(this.version=parseInt(tmp[1]));var tmp2=i.match(new RegExp("orgid/([a-zA-Z0-9-]+)"));tmp2&&2==tmp2.length&&(this.orgid=tmp2[1]);var tmp3=j.match(new RegExp("deviceid/([a-zA-Z0-9-_.]+)"));tmp3&&2==tmp3.length&&(this.deviceId=tmp3[1]);var tmp4=j.match(new RegExp("token/([a-zA-Z0-9-_.]+)"));tmp4&&2==tmp4.length&&(this.token=tmp4[1]);var tmp5=j.match(new RegExp("userid/([a-zA-Z0-9-_.]+)"));tmp5&&2==tmp5.length&&(this.userid=tmp5[1])}console.log(this.isY?"this is yunxuetang app!":"this is not yunxuetang app!")}},window.y_bridge_public.init(),window.y_bridge_util={play_doc:function(i){if(window.y_bridge_public.isY){window.y_bridge_public.NaEptObj(i)&&window.y_bridge_public.NaEptObj(i.param)&&(i.param.hasOwnProperty("pid")&&(i.param.pid=i.param.pid||""),i.param.hasOwnProperty("cid")&&(i.param.cid=i.param.cid||""));var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","play_doc",_)}},play_video:function(i){if(window.y_bridge_public.isY){window.y_bridge_public.NaEptObj(i)&&window.y_bridge_public.NaEptObj(i.param)&&(i.param.hasOwnProperty("pid")&&(i.param.pid=i.param.pid||""),i.param.hasOwnProperty("cid")&&(i.param.cid=i.param.cid||""));var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","play_video",_)}},play_esdoc:function(id,url,type,backurl){if(!window.y_bridge_public.isY)return void(self.location.href=url);var params={key:id,type:type,backurl:escape(backurl)},result=null;if(jQuery.ajax({type:"GET",url:"/m/ppvjs",async:!1,contentType:"application/json",dataType:"json",data:params,success:function(data){"ok"==data.Code&&(result=data.Data)},error:function(msg){console.log(msg),grg}}),null!=result){i={param:{uid:result.uid,title:result.title,url:result.url,type:result.type,sp:result.sp,ep:result.ep,callback:result.callback,backurl:result.backurl,istrack:result.istrack},CBPluginName:"",CBTagName:""};var t=i.param,_=window.y_bridge_public.buildParamString(t,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","play_doc",_)}},play_esvideo:function(id,url,type,backurl){if(!window.y_bridge_public.isY)return void(self.location.href=url);var params={key:id,type:type,backurl:escape(backurl)},result=null;if(jQuery.ajax({url:"/m/ppvjs",async:!1,contentType:"application/json; charset=utf-8",dataType:"json",data:params,success:function(data){"ok"==data.Code&&(result=data.Data)}}),null!=result){i={param:{uid:result.uid,title:result.title,url:result.url,type:result.type,sp:result.sp,ep:result.ep,callback:result.callback,backurl:result.backurl,istrack:result.istrack},CBPluginName:"",CBTagName:""};var t=({url:"",uid:result.uid,ats:120,ts:60},i.param),_=window.y_bridge_public.buildParamString(t,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","play_video",_)}},req_down:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","req_down",_)}},getEasyJsUrl:function(i,t,_){window.y_bridge_public.loadURL("yxtapp:"+i+":"+encodeURIComponent(t)+":"+encodeURIComponent(_))},getEasyJsUrlUnSafe:function(i,t,_){window.y_bridge_public.loadURL("unsafe:yxtapp:"+i+":"+encodeURIComponent(t)+":"+encodeURIComponent(_))},user_login:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","user_login",_)}},user_changeorg:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","user_changeorg",_)}},user_reg:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","user_reg",_)}},user_logout:function(){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString({},"","");this.getEasyJsUrl("ntv_util","user_logout",_)}},user_takephoto:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","user_takephoto",_)}},pay_ali:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","pay_ali",_)}},sys_info:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.version>=10040){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","sys_info",_)}},sys_scan:function(i){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);this.getEasyJsUrl("ntv_util","sys_scan",_)}},open_home:function(homeUrl){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString({},"","");this.getEasyJsUrl("ntv_util","open_home",_)}else homeUrl&&null!=homeUrl&&(self.location.href=homeUrl)},open_download:function(){if(window.y_bridge_public.isY){var _=window.y_bridge_public.buildParamString({},"","");this.getEasyJsUrl("ntv_util","open_download",_)}},set_topic:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){var _=JSON.stringify(i);return window.y_bridge_util.getEasyJsUrlUnSafe("ntv_util","topic",_)}}},window.y_bridge_bar={set_article:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){var _=JSON.stringify(i);return window.y_bridge_util.getEasyJsUrlUnSafe("ntv_util","article",_)}},set_comment:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){var _=JSON.stringify(i);return window.y_bridge_util.getEasyJsUrlUnSafe("ntv_util","comment",_)}},set_navbar:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){window.y_bridge_public.isToolbarHidden=i.param.isToolbarHidden;var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);return window.y_bridge_util.getEasyJsUrl("ntv_bar","set_navbar",_)}},set_toolbar:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){window.y_bridge_public.isNavbarHidden=i.param.isNavbarHidden;var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);window.y_bridge_util.getEasyJsUrl("ntv_bar","set_toolbar",_)}},set_toolbar_select:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){window.y_bridge_public.isNavbarHidden=i.param.isNavbarHidden;var _=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);window.y_bridge_util.getEasyJsUrl("ntv_bar","set_toolbar_select",_)}},set_navbar_share:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){var t=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);window.y_bridge_util.getEasyJsUrl("ntv_bar","set_navbar_share",t)}},shareInfoFromH5:function(i){if(window.y_bridge_public.isY&&window.y_bridge_public.NaEptObj(i)){var t=window.y_bridge_public.buildParamString(i.param,i.CBPluginName,i.CBTagName);window.y_bridge_util.getEasyJsUrl("ntv_bar","shareInfoFromH5",t)}}};
angular.module("c.business",[]).controller("BusinessCtrl",function($scope,$rootScope,BusinessService){function filterBusinesses(subTime,dealType){$scope.businessList=[],params.offset=0,params.subTime=subTime,params.dealType=dealType,$scope.isbusy=!1,$scope.nodata=!1,$(".filter-group").hide(),$scope.$emit("emitLoadPage")}$rootScope.pagetitle="商机",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.switchDeriection=function(){$scope.businessList=[],$(".business-date.arrow-direction").toggleClass("active"),params.offset=0,params.direction="DESC"==params.direction?"ASC":"DESC",$scope.isbusy=!1,$scope.isloaded=!1,$scope.nextPage()},$scope.slideSearch=function(){$(".search-box").slideToggle()},$scope.toggleFilter=function(){$(".filter-group").slideToggle(200),$(".clue-filter.arrow-direction").toggleClass("active")},$scope.showFilter=!1,$scope.filterName="全部商机",$scope.filterIndex=0,$scope.getAllBusinesses=function(){$scope.filterName="全部商机",$scope.filterIndex=0,filterBusinesses("","")},$scope.getMyChargeBusinesses=function(){$scope.filterName="我负责的商机",$scope.filterIndex=1,filterBusinesses("","0")},$scope.getMyAssistBusinesses=function(){$scope.filterName="我协助的商机",$scope.filterIndex=2,filterBusinesses("","1")},$scope.get7UndoneBusinesses=function(){$scope.filterName="7天未跟进的商机",$scope.filterIndex=3,filterBusinesses("7","")},$scope.get14UndoneBusinesses=function(){$scope.filterName="14天未跟进的商机",$scope.filterIndex=4,filterBusinesses("14","")},$scope.isbusy=!1,$scope.isloaded=!1,$scope.nodata=!1,$scope.isloading=!1,$scope.businessList=[];var params={subTime:"",dealType:"",limit:8,offset:0,orderby:"createTime",direction:"DESC"};$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,BusinessService.getBusinessList(params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){$scope.businessList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(8>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.businessList.length>=8&&($scope.isloaded=!0))))}))};var oldKey="";$scope.search=function(){var key=$scope.keyword;oldKey!=key&&(oldKey=key,$scope.nodata=!1,$scope.isloaded=!1,$scope.businessList=[],params={limit:8,offset:0,key:key},$scope.isbusy=!1,$scope.$emit("emitLoadPage"))}}).controller("BusinessDetailCtrl",function($scope,$rootScope,$state,$stateParams,BusinessService,ClueService,CommonService){function loadInit(){$scope.isbusy=!1,$scope.isloaded=!1,$scope.nodata=!1,$scope.clueLogList=[],params={limit:6,offset:0,orderby:"createTime",direction:"DESC"}}$rootScope.pagetitle="商机详情",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.index=0,$scope.tab=function(index){$scope.index=index},$scope.toggleObject=function(index){$(".object-list button:eq("+index+")").toggleClass("btn-bg-blue")};var businessId=$stateParams.businessId,hasJuster=!1;BusinessService.getBusinessDetail(businessId,function(data){$scope.business=data,angular.forEach(data.contacts,function(contact){5==contact.type&&(hasJuster=!0)})}),$scope.editStatus=function(){return hasJuster?void $state.go("business.status",{businessId:businessId}):(dialog("您还没有找到决策者，不能更改商机状态！"),!1)},$scope.returnCase=function(backReason){var body={businessId:businessId,intro:backReason,status:-2};ClueService.addClueLog(body,function(data){$state.go("business")})};var clueId=$stateParams.businessId,params={};loadInit(),$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,ClueService.getClueLogList(clueId,params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(clueLog){$scope.clueLogList.push(clueLog)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(6>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.clueLogList.length>=8&&($scope.isloaded=!0))))}))},$scope.addClueLog=function(clueLog){if(""==$.trim(clueLog))return dialog("跟进纪录不能为空！"),!1;var contactId="";$(".object-list .btn-bg-blue").each(function(index){0==index?contactId+=$(this).data().contactid:contactId=contactId+";"+$(this).data().contactid});var body={businessId:clueId,contactId:contactId,intro:clueLog,status:$scope.business.status,type:1};ClueService.addClueLog(body,function(data){$scope.business.logCount++,$scope.clueLog="",loadInit(),$scope.nextPage()})}}).controller("BusinessContactCtrl",function($scope,$rootScope,$state,$stateParams,BusinessService){$rootScope.pagetitle="新增联系人",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var businessId=$stateParams.businessId;$scope.businessId=businessId,$scope.index=0,$scope.tab=function(index){$scope.index=index},$scope.showAddList=!0,$scope.showInput=function(tagName){$scope.tagName=tagName,$scope.showAddList=!1},$scope.selectRole=function(roleIndex){$scope.roleIndex=roleIndex;var obj={0:"发起人",1:"使用者",2:"影响者",3:"守门人",4:"购买者",5:"决策者"};$scope.role=obj[roleIndex],$scope.showAddList=!0},$scope.addContact=function(){var params={type:$scope.roleIndex,cardUrl:"",department:$scope.department,email:$scope.email,position:$scope.job,mobile:$scope.mobile,name:$scope.contactName,ramark:$scope.remark,sex:$scope.genderIndex};BusinessService.addContact(businessId,params,function(data){$state.go("business.detail",{businessId:businessId})})}}).controller("BusinessStatusCtrl",function($scope,$rootScope,$state,$stateParams,BusinessService){$rootScope.pagetitle="商机状态",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var businessId=$stateParams.businessId;BusinessService.getBusinessDetail(businessId,function(data){$scope.status=data.status}),$scope.tag=function(index){index!=$scope.status&&($scope.statusIndex=index,-3==index&&$(".lose-reason").slideDown())},$scope.postStatus=function(){var status=$scope.statusIndex;return-3!=status||void 0!==$scope.loseReason&&""!==$.trim($scope.loseReason)?void BusinessService.postStatus(businessId,status,function(data){$state.go("business.detail",{businessId:businessId})}):(dialog("请填写输单理由！"),!1)}}).controller("BusinessTeamCtrl",function($scope,$rootScope,$state,$stateParams,BusinessService){$rootScope.pagetitle="团队详情",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.slideSearch=function(){$(".search-box").slideToggle()},$scope.isManager=!1;var businessId=$stateParams.businessId;BusinessService.getBusinessDetail(businessId,function(data){$scope.maps=data.maps,angular.forEach(data.maps,function(map){0==map.type&&map.userId==getLocalStorage("userId")&&($scope.isManager=!0)})}),$scope.isbusy=!0,$scope.isloaded=!1,$scope.nodata=!1,$scope.memberList=[];var params={};$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,BusinessService.getMemberList(params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){$scope.memberList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(8>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.memberList.length>=8&&($scope.isloaded=!0))))}))};var oldKey="";$scope.search=function(){var key=$scope.keyword;oldKey!=key&&(oldKey=key,$scope.nodata=!1,$scope.isloaded=!1,$scope.memberList=[],params={businessId:businessId,limit:10,offset:0,key:key},$scope.isbusy=!1,$scope.$emit("emitLoadPage"))},$scope.addMember=function(toUserId,headPictureUrl,nickName,mobile,email){BusinessService.addMember(businessId,toUserId,1,function(data){$scope.maps.push({headPictureUrl:headPictureUrl,userName:nickName,mobile:mobile,email:email})})}}),angular.module("c.clue",[]).controller("ClueCtrl",function($scope,$rootScope,$state,CommonService,ClueService){function filterClues(subTime){$scope.clueList=[],params.offset=0,"none"==subTime?flag=1:(flag=0,params.subTime=subTime),$scope.isbusy=!1,$scope.isloaded=!1,$scope.nodata=!1,$(".filter-group").hide(),$scope.nextPage()}$rootScope.pagetitle="线索",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.switchDeriection=function(){$scope.clueList=[],$(".clue-date.arrow-direction").toggleClass("active"),params.offset=0,params.direction="DESC"==params.direction?"ASC":"DESC",$scope.isbusy=!1,$scope.isloaded=!1,$scope.nextPage()},$scope.goToAddClue=function(){CommonService.clearRootScope(),$state.go("clue.add")},$scope.toggleFilter=function(){$(".filter-group").slideToggle(200),$(".clue-filter.arrow-direction").toggleClass("active")},$scope.filterName="分配给我的线索",$scope.filterIndex=0,$scope.getAllClues=function(){$scope.filterName="分配给我的线索",filterClues(""),$scope.filterIndex=0},$scope.get7UndoneClues=function(){$scope.filterName="7天未跟进的线索",filterClues("7"),$scope.filterIndex=1},$scope.get14UndoneClues=function(){$scope.filterName="14天未跟进的线索",filterClues("14"),$scope.filterIndex=2},$scope.getMyReportClues=function(){$scope.filterName="我上报的线索",filterClues("none"),$scope.filterIndex=3},$scope.isbusy=!1,$scope.isloaded=!1,$scope.nodata=!1,$scope.isloading=!1,$scope.clueList=[];var params={subTime:"",limit:8,offset:0,orderby:"createTime",direction:"DESC"},flag=0;$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,ClueService.getClueList(flag,params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){$scope.clueList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(8>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.clueList.length>=8&&($scope.isloaded=!0))))}))}}).controller("ClueDetailCtrl",function($scope,$rootScope,$stateParams,$state,ClueService,CommonService){function loadInit(){$scope.isbusy=!1,$scope.isloaded=!1,$scope.nodata=!1,$scope.clueLogList=[],params={limit:6,offset:0,orderby:"createTime",direction:"DESC"}}$rootScope.pagetitle="线索详情",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var clueId=$stateParams.clueId;$scope.isMyAdd=!1,ClueService.getClueDetail(clueId,function(data){$scope.clue=data;var userId=getLocalStorage("userId");data.maps[0].userId!=userId&&($scope.isMyAdd=!0)}),$scope.returnCase=function(backReason){var body={businessId:clueId,intro:backReason,status:-1};ClueService.addClueLog(body,function(data){$state.go("clue")})},$scope.index=0,$scope.tab=function(index){$scope.index=index},loadInit(),$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,ClueService.getClueLogList(clueId,params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){0==value.type&&$scope.clueLogList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(6>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.clueLogList.length>=8&&($scope.isloaded=!0))))}))},$scope.clueLog="",$scope.checked=!1,$scope.effectiveValue=1,$scope.addClueLog=function(clueLog){if(""==$.trim(clueLog))return dialog("跟进纪录不能为空！"),!1;var body={businessId:clueId,intro:clueLog};0==$scope.clue.isEffective&&(body.isEffective=$scope.effectiveValue,body.status=$scope.effectiveValue),$scope.checked&&(body.status=2,body.type=1),ClueService.addClueLog(body,function(data){$scope.clue.logCount=$scope.clue.logCount+1,$scope.clueLog="",$scope.clue.status=$scope.effectiveValue,$scope.clue.isEffective=$scope.effectiveValue,$scope.checked&&$state.go("business"),loadInit(),$scope.nextPage()})}}).controller("ClueAddCtrl",function($scope,$stateParams,$state,$rootScope,ClueService,CommonService){function validateInput(){if(void 0===$rootScope.contactName||""===$rootScope.contactName)return dialog("请填写姓名！"),!1;if(void 0===$rootScope.companyName||""===$rootScope.companyName)return dialog("请选择公司！"),!1;if(void 0===$rootScope.department||""===$rootScope.department)return dialog("请填写部门！"),!1;if(void 0===$rootScope.job||""===$rootScope.job)return dialog("请填写职务！"),!1;if(void 0===$rootScope.productIds||""===$rootScope.productIds)return dialog("请选择产品！"),!1;if(void 0===$rootScope.mobile||""===$rootScope.mobile)return dialog("请填写电话！"),!1;var mobile=$rootScope.mobile,moblieReg=/^(((13[0-9]{1})|(15[0-9]{1})|(17[0-9]{1})|(18[0-9]{1}))+\d{8})$/;if(!moblieReg.test(mobile))return dialog("请输入有效的手机号码！"),!1;if(void 0===$rootScope.email||void 0===$rootScope.email)return dialog("请填写邮箱！"),!1;var email=$rootScope.email;if(0!=$.trim(email).length){var emailReg=/^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$/;if(!emailReg.test(email))return dialog("请输入有效的邮箱地址！"),!1}return void 0===$rootScope.industryName||""===$rootScope.industryName?(dialog("请选择行业"),!1):void 0===$rootScope.areaName||""===$rootScope.areaName?(dialog("请选择地区"),!1):!0}$rootScope.pagetitle="新增线索",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.goToCheckClue=function(){$rootScope.orgName=void 0,$state.go("clue.check")},void 0!==$rootScope.genderIndex&&""!==$rootScope.genderIndex||($rootScope.genderIndex=1),$scope.passValue=function(target){switch(target){case"contactName":$rootScope.contactName=$scope.contactName;break;case"department":$rootScope.department=$scope.department;break;case"email":$rootScope.email=$scope.email;break;case"job":$rootScope.job=$scope.job;break;case"mobile":$rootScope.mobile=$scope.mobile;break;case"remark":$rootScope.remark=$scope.remark;break;case"genderIndex":$rootScope.genderIndex=$scope.genderIndex;break;case"address":$rootScope.address=$scope.address;break;case"sourceDes":$rootScope.sourceDes=$scope.sourceDes}},$scope.addClue=function(){if(!validateInput())return!1;var body={areaId:$rootScope.areaId,areaName:$rootScope.areaName,orgName:$rootScope.companyName,productIds:$rootScope.productIds,type:0,cardUrl:"",department:$rootScope.department,email:$rootScope.email,position:$rootScope.job,industryId:$rootScope.industryId,industryName:$rootScope.industryName,mobile:$rootScope.mobile,name:$rootScope.contactName,ramark:$rootScope.remark,sex:$rootScope.genderIndex,address:$rootScope.address,intro:$rootScope.productRemark,sourceType:$rootScope.sourceType,sourceDes:$rootScope.sourceDes};ClueService.addClue(body,function(data){CommonService.clearRootScope(),$state.go("clue.ok")})}}).controller("ClueSearchOrgNameCtrl",function($scope,$rootScope,$state,ClueService){$rootScope.pagetitle="公司查询",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.isbusy=!0,$scope.isloaded=!1,$scope.nodata=!1,$scope.itemList=[];var params={};$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,ClueService.searchOrgName(params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){$scope.itemList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(8>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.itemList.length>=8&&($scope.isloaded=!0))))}))};var oldKey="";$scope.search=function(){var key=$.trim($scope.keyword);if(oldKey!=key&&void 0!==key&&""!==key){if(oldKey=key,1==key.length)return void dialog("请输入至少两个字符");$scope.nodata=!1,$scope.isloaded=!1,$scope.itemList=[],params={limit:10,offset:0,keyword:key},$scope.isbusy=!1,$scope.nextPage()}},$scope.selectCompany=function(companyName){$rootScope.companyName=companyName,$state.go("clue.add")}}).controller("ClueCheckCtrl",function($scope,$rootScope,$state,ClueService){$rootScope.pagetitle="线索查重",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),$scope.isbusy=!0,$scope.isloaded=!1,$scope.nodata=!1,$scope.checkList=[],$rootScope.orgName&&($scope.keyword=$rootScope.orgName,$scope.isbusy=!1,$scope.$emit("emitSearch"));var params={limit:8,offset:0,key:$rootScope.orgName};$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,ClueService.searchClueByOrgName(params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){$scope.checkList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(8>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.checkList.length>=8&&($scope.isloaded=!0))))}))};var oldOrgName="";$scope.search=function(){var orgName=$scope.keyword;$rootScope.orgName=orgName,oldOrgName!=orgName&&(oldOrgName=orgName,$scope.nodata=!1,$scope.isloaded=!1,$scope.checkList=[],angular.isNullOrEmpty($.trim(orgName))||(params={limit:8,offset:0,key:orgName},$scope.isbusy=!1,$scope.$emit("emitSearch")))}}).controller("ClueCheckDetailCtrl",function($scope,$rootScope,$stateParams,ClueService){$rootScope.pagetitle="线索详情",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var clueId=$stateParams.checkId;ClueService.getClueDetail(clueId,function(data){$scope.clue=data})}).controller("ClueSourceCtrl",function($scope,$rootScope,$state){$rootScope.pagetitle="线索来源",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var array=["销售获取","市场活动","合作渠道","推广渠道","公司官网","公司微信","在线客服","产品注册","独立合伙人","老板关系","老客户转介绍","其他"];$scope.sourceToAdd=function(sourceType){$rootScope.sourceType=sourceType,$rootScope.sourceName=array[sourceType-1],$state.go("clue.add")}}),angular.module("c.common",[]).controller("ProductCtrl",function($scope,$rootScope,$state,CommonService){$rootScope.pagetitle="产品列表",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),CommonService.getProductList(function(data){$scope.productList=data.datas,$scope.toggle=function(index){$(".product-list li:eq("+index+")").toggleClass("active")};var productIds=[];$scope.productToAdd=function(){var txt="";$.each($(".product-list li.active"),function(index){0==index?txt+=$(this).find("span").text():txt=txt+" | "+$(this).find("span").text(),productIds.push($(this).data().productid)}),$rootScope.productIds=productIds,$rootScope.productName=txt,$rootScope.productRemark=$scope.productRemark,$state.go("clue.add")}})}).controller("AreaCtrl",function($scope,$rootScope,$state,CommonService){$rootScope.pagetitle="地区列表",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),CommonService.getAreas(function(data){$scope.areaList=data.datas}),$scope.goToSubarea=function(areaId,areaName){$rootScope.areaName=areaName,$state.go("area.subarea",{areaId:areaId})}}).controller("SubAreaCtrl",function($scope,$rootScope,$stateParams,$state,CommonService){$rootScope.pagetitle="地区列表",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var areaId=$stateParams.areaId;CommonService.getSubareas(areaId,function(data){$scope.subareaList=data.datas}),$scope.areaToAdd=function(areaId,areaName){$rootScope.areaName+=" "+areaName,$rootScope.areaId=areaId,$state.go("clue.add")}}).controller("IndustryCtrl",function($scope,$rootScope,$state,CommonService){$rootScope.pagetitle="行业列表",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),CommonService.getIndustries(function(data){$scope.industryList=data.datas}),$scope.goToSubindustry=function(industryId,industryName){$rootScope.industryName=industryName,$state.go("industry.subindustry",{industryId:industryId})}}).controller("SubIndustryCtrl",function($scope,$rootScope,$stateParams,$state,CommonService){$rootScope.pagetitle="行业列表",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var industryId=$stateParams.industryId;CommonService.getSubindustries(industryId,function(data){$scope.subindustryList=data.datas}),$scope.industryToAdd=function(industryId,industryName){$rootScope.industryId=industryId,$rootScope.industryName=industryName,$state.go("clue.add")}}),angular.module("c.contract",[]).controller("ContractCtrl",function($scope,ContractService){}),angular.module("c.data",[]).controller("DataCtrl",function($scope,DataService){}),angular.module("c.home",[]).controller("HomeCtrl",function($scope,$rootScope,$q,HomeService){$rootScope.pagetitle="CRM",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var userId=getLocalStorage("userId"),params={userId:userId};setLocalStorage("userId",userId),HomeService.logIn(params,function(data){var token=data.token,orgId=data.orgId;setLocalStorage("crm_token",token),setLocalStorage("orgId",orgId),HomeService.getUserInfo(function(data){var role=data.type;setLocalStorage("role",role)})})}),angular.module("c.market",[]).controller("MarketCtrl",function($scope,MarketService){}),angular.module("c.team",[]).controller("TeamCtrl",function($scope,$rootScope,$stateParams,TeamService){$rootScope.pagetitle="我的团队",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}}),TeamService.getTeamList(function(data){0==data.datas.length&&($scope.nodata=!0);var teamList=[];angular.forEach(data.datas,function(team){angular.forEach(team.users,function(user){1==user.type&&(team.leader=user.userName)}),teamList.push(team)}),$scope.teamList=teamList})}).controller("TeamDetailCtrl",function($scope,$rootScope,$stateParams,TeamService){$rootScope.pagetitle="团队详情",window.y_bridge_bar.set_navbar({param:{title:$rootScope.pagetitle}});var teamId=$stateParams.teamId,areaId=$stateParams.areaId;$scope.isManager=!1,TeamService.getTeamDetail(teamId,areaId,function(data){var team=data;angular.forEach(data.users,function(user){1==user.type&&(team.leader=user.userName,user.userId==getLocalStorage("userId")&&($scope.isManager=!0))}),$scope.team=team}),$scope.slideSearch=function(){$(".search-box").slideToggle()},$scope.isbusy=!0,$scope.isloaded=!1,$scope.nodata=!1,$scope.memberList=[];var params={};$scope.nextPage=function(){$scope.isbusy||($scope.isbusy=!0,$scope.isloading=!0,TeamService.getMemberList(params,function(data){var len=data.datas.length;return 0==len&&0==params.offset?($scope.isloading=!1,void($scope.nodata=!0)):(angular.forEach(data.datas,function(value){$scope.memberList.push(value)}),params.offset+=params.limit,$scope.isloading=!1,$scope.isbusy=!1,void(8>len&&($scope.isloading=!1,$scope.isbusy=!0,$scope.memberList.length>=8&&($scope.isloaded=!0))))}))};var oldKey="";$scope.search=function(){var key=$scope.keyword;oldKey!=key&&void 0!==key&&""!==key&&(oldKey=key,$scope.nodata=!1,$scope.isloaded=!1,$scope.memberList=[],params={teamId:teamId,limit:10,offset:0,key:key},$scope.isbusy=!1,$scope.nextPage())},$scope.addMember=function(userId,headPictureUrl,userName,mobile,email){var params={teamId:teamId,userId:userId,type:0};TeamService.addMember(params,function(data){$scope.team.users.push({headPictureUrl:headPictureUrl,userName:userName,mobile:mobile,email:email})})},$scope.showDel=!1,$scope.delMember=function(userId,index){var params={teamId:teamId,userId:userId};TeamService.delMember(params,function(data){$scope.team.users.splice(index,1)})}});
angular.module("factoryApp",[]).factory("apiManager",function($http,$location){function xhr(domin,option,headers){var opt={method:option.method,url:domin+option.url,ignoreLoadingBar:option.ignoreLoadingBar,headers:headers};"get"==option.method.toLowerCase()?opt.params=option.data:opt.data=option.data,$http(opt).success(function(data){data.IsSuccessStatusCode=!0,angular.isFunction(option.success)&&option.success(data)}).error(function(data,status){data.IsSuccessStatusCode=!1,dialog(data.error.message),angular.isFunction(option.error)&&option.error(data)})}var factory={},source="706";return factory.callApi=function(option){var headers={Source:source,Token:getLocalStorage("crm_token"),OrgId:getLocalStorage("orgId")};xhr(BASE_URL,option,headers)},factory.callComApi=function(option){var headers={Source:source,Token:getLocalStorage("crm_token")};xhr(COM_URL,option,headers)},factory.callLogInApi=function(option){var headers={Source:source};xhr(LOG_URL,option,headers)},factory}),angular.module("s.business",[]).service("BusinessService",function(apiManager){this.getBusinessList=function(params,success){apiManager.callApi({method:"get",url:"business/businesses",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.getBusinessDetail=function(businessId,success){apiManager.callApi({method:"get",url:"business/"+businessId,success:function(data){angular.isFunction(success)&&success(data)}})},this.addContact=function(businessId,params,success){apiManager.callApi({method:"post",url:"business/"+businessId+"/addContact/",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.postStatus=function(businessId,status,success){apiManager.callApi({method:"put",url:"business/"+businessId,data:{status:status},success:function(data){angular.isFunction(success)&&success(data)}})},this.getMemberList=function(params,success){apiManager.callApi({method:"get",url:"users/notInBusinessMap",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.addMember=function(businessId,toUserId,type,success){apiManager.callApi({method:"put",url:"business/"+businessId+"/assigned/"+toUserId,data:{type:type},success:function(data){angular.isFunction(success)&&success(data)}})}}),angular.module("s.clue",[]).service("ClueService",function(apiManager){this.getProductList=function(success){apiManager.callApi({method:"get",url:"product",success:function(data){angular.isFunction(success)&&success(data)}})},this.searchClueByOrgName=function(params,success){apiManager.callApi({method:"get",url:"business/searchByOrgName",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.addClue=function(body,success){apiManager.callApi({method:"post",url:"business",data:body,success:function(data){angular.isFunction(success)&&success(data)}})},this.getClueList=function(flag,params,success){var href="";href=0==flag?"business/clues":"business/myClues",apiManager.callApi({method:"get",url:href,data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.getMyReportClues=function(){apiManager.callApi({method:"get",url:"business/myClues",success:function(data){angular.isFunction(success)&&success(data)}})},this.getClueDetail=function(businessId,success){apiManager.callApi({method:"get",url:"business/"+businessId,success:function(data){angular.isFunction(success)&&success(data)}})},this.searchOrgName=function(params,success){apiManager.callComApi({method:"post",url:"eci/companies/search",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.getClueLogList=function(businessId,params,success){apiManager.callApi({method:"get",url:"businesslog/"+businessId+"/log",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.addClueLog=function(body,success){apiManager.callApi({method:"post",url:"businesslog",data:body,success:function(data){angular.isFunction(success)&&success(data)}})},this.getClueRecordList=function(userid,success){apiManager.callApi({method:"get",url:"captchas/"+mobile,data:{type:1},success:function(data){angular.isFunction(success)&&success(data)}})}}),angular.module("s.common",[]).service("CommonService",function($rootScope,apiManager){this.getProductList=function(success){apiManager.callApi({method:"get",url:"product",success:function(data){angular.isFunction(success)&&success(data)}})},this.getIndustries=function(success){apiManager.callComApi({method:"get",url:"industries/0/subindustries",success:function(data){angular.isFunction(success)&&success(data)}})},this.getSubindustries=function(industryId,success){apiManager.callComApi({method:"get",url:"industries/"+industryId+"/subindustries",success:function(data){angular.isFunction(success)&&success(data)}})},this.getAreas=function(success){apiManager.callComApi({method:"get",url:"areas/0/subareas",success:function(data){angular.isFunction(success)&&success(data)}})},this.getSubareas=function(areaId,success){apiManager.callComApi({method:"get",url:"areas/"+areaId+"/subareas",success:function(data){angular.isFunction(success)&&success(data)}})},this.clearRootScope=function(){$rootScope.areaId="",$rootScope.areaName="",$rootScope.companyName="",$rootScope.productIds="",$rootScope.productName="",$rootScope.department="",$rootScope.email="",$rootScope.job="",$rootScope.industryId="",$rootScope.industryName="",$rootScope.mobile="",$rootScope.contactName="",$rootScope.remark="",$rootScope.genderIndex="",$rootScope.address="",$rootScope.productRemark="",$rootScope.sourceType="",$rootScope.sourceName="",$rootScope.sourceDes=""},this.returnCase=function(businessId,status,success){apiManager.callApi({method:"put",url:"business/"+businessId+"/return",data:{status:status},success:function(data){angular.isFunction(success)&&success(data)}})}}),angular.module("s.contract",[]).service("ContractService",function(apiManager){}),angular.module("s.data",[]).service("DataService",function(apiManager){}),angular.module("s.home",[]).service("HomeService",function(apiManager){this.logIn=function(params,success){apiManager.callLogInApi({method:"post",url:"users/qida/tokens",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.getUserInfo=function(success){apiManager.callApi({method:"get",url:"users",success:function(data){angular.isFunction(success)&&success(data)}})}}),angular.module("s.market",[]).service("MarketService",function(apiManager){}),angular.module("s.team",[]).service("TeamService",function(apiManager){this.getTeamList=function(success){apiManager.callApi({method:"get",url:"team",success:function(data){angular.isFunction(success)&&success(data)}})},this.getMemberList=function(params,success){apiManager.callApi({method:"get",url:"users/notInTeam",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.getTeamDetail=function(teamId,domainId,success){apiManager.callApi({method:"get",url:"team/"+teamId,data:{domainId:domainId},success:function(data){angular.isFunction(success)&&success(data)}})},this.addMember=function(params,success){apiManager.callApi({method:"post",url:"team/addUser",data:params,success:function(data){angular.isFunction(success)&&success(data)}})},this.delMember=function(params,success){apiManager.callApi({method:"post",url:"users/deleteUserFromTeam/?userId="+params.userId+"&teamId="+params.teamId,success:function(data){angular.isFunction(success)&&success(data)}})}});
angular.module("routeApp",["ui.router"]).run(function($rootScope,$state,$stateParams,$location){$rootScope.$on("$stateChangeSuccess",function(){}),$rootScope.$on("$stateChangeStart",function(event,toState){})}).config(["cfpLoadingBarProvider",function(cfpLoadingBarProvider){cfpLoadingBarProvider.includeSpinner=!1}]).config(function($stateProvider,$urlRouterProvider,$locationProvider){$urlRouterProvider.when("/","index").otherwise("index"),$stateProvider.state("home",{url:"/home",views:{main:{templateUrl:"./views/home/index.html?v="+APP_VERSION,controller:"HomeCtrl"}}}).state("clue",{url:"/clue",views:{main:{templateUrl:"./views/clue/index.html?v="+APP_VERSION,controller:"ClueCtrl"}}}).state("clue.source",{url:"/source",views:{"main@":{templateUrl:"./views/clue/source.html?v="+APP_VERSION,controller:"ClueSourceCtrl"}}}).state("clue.detail",{url:"/:clueId/detail",views:{"main@":{templateUrl:"./views/clue/detail.html?v="+APP_VERSION,controller:"ClueDetailCtrl"}}}).state("clue.add",{url:"/add",views:{"main@":{templateUrl:"./views/clue/add.html?v="+APP_VERSION,controller:"ClueAddCtrl"}}}).state("clue.ok",{url:"/ok",views:{"main@":{templateUrl:"./views/clue/ok.html?v="+APP_VERSION}}}).state("clue.searchOrgName",{url:"/searchOrgName",views:{"main@":{templateUrl:"./views/clue/searchOrgName.html?v="+APP_VERSION,controller:"ClueSearchOrgNameCtrl"}}}).state("product",{url:"/product",views:{"main@":{templateUrl:"./views/common/product.html?v="+APP_VERSION,controller:"ProductCtrl"}}}).state("area",{url:"/area",views:{"main@":{templateUrl:"./views/common/area.html?v="+APP_VERSION,controller:"AreaCtrl"}}}).state("area.subarea",{url:"/:areaId/subarea",views:{"main@":{templateUrl:"./views/common/subArea.html?v="+APP_VERSION,controller:"SubAreaCtrl"}}}).state("industry",{url:"/industry",views:{"main@":{templateUrl:"./views/common/industry.html?v="+APP_VERSION,controller:"IndustryCtrl"}}}).state("industry.subindustry",{url:"/:industryId/subIndustry",views:{"main@":{templateUrl:"./views/common/subIndustry.html?v="+APP_VERSION,controller:"SubIndustryCtrl"}}}).state("clue.check",{url:"/check",views:{"main@":{templateUrl:"./views/clue/check.html?v="+APP_VERSION,controller:"ClueCheckCtrl"}}}).state("clue.check.detail",{url:"/:checkId/detail",views:{"main@":{templateUrl:"./views/clue/checkDetail.html?v="+APP_VERSION,controller:"ClueCheckDetailCtrl"}}}).state("business",{url:"/business",views:{main:{templateUrl:"./views/business/index.html?v="+APP_VERSION,controller:"BusinessCtrl"}}}).state("business.detail",{url:"/:businessId/detail",views:{"main@":{templateUrl:"./views/business/detail.html?v="+APP_VERSION,controller:"BusinessDetailCtrl"}}}).state("business.contact",{url:"/:businessId/contact",views:{"main@":{templateUrl:"./views/business/contact.html?v="+APP_VERSION,controller:"BusinessContactCtrl"}}}).state("business.status",{url:"/:businessId/status",views:{"main@":{templateUrl:"./views/business/status.html?v="+APP_VERSION,controller:"BusinessStatusCtrl"}}}).state("business.team",{url:"/:businessId/team",views:{"main@":{templateUrl:"./views/business/team.html?v="+APP_VERSION,controller:"BusinessTeamCtrl"}}}).state("contract",{url:"/contract",views:{main:{templateUrl:"./views/contract/index.html?v="+APP_VERSION,controller:"ContractCtrl"}}}).state("market",{url:"/market",views:{main:{templateUrl:"./views/market/index.html?v="+APP_VERSION,controller:"MarketCtrl"}}}).state("team",{url:"/team",views:{main:{templateUrl:"./views/team/index.html?v="+APP_VERSION,controller:"TeamCtrl"}}}).state("team.detail",{url:"/:areaId/:teamId/detail",views:{"main@":{templateUrl:"./views/team/detail.html?v="+APP_VERSION,controller:"TeamDetailCtrl"}}}).state("data",{url:"/data",views:{main:{templateUrl:"./views/data/index.html?v="+APP_VERSION,controller:"DataCtrl"}}})});
var athena_directive=angular.module("ui.athena",[]).directive("searchBar",function($timeout){return{replace:!0,scope:{placeholder:"@placehold",keyword:"=",search:"="},templateUrl:"searchbar.html",link:function(scope,ele,attrs){scope.input=function(){scope.focus=!0,$timeout(function(){ele[0].querySelector("input").focus()})},scope.hideInput=function(){scope.focus=!1},scope.clear=function(){scope.keyword=null},ele.on("submit",function(e){scope.search(e)})}}});athena_directive.run(["$templateCache",function($templateCache){$templateCache.put("searchbar.html",'<form>        <div class="searchbar-wrap" ng-class="{true : \'focus\'}[focus]">        <div class="searchbar" ng-click="input()">        <i class="fa fa-search"></i>        <div class="searchbar-text" ng-bind="placeholder"></div>        <div class="searchbar-input"><input ng-model="keyword" type="text" placeholder="{{placeholder}}" autocapitalize="off"></div>        <i class="fa fa-times-circle" ng-click="clear()"></i>        </div>        <button class="searchbar-cancel" ng-click="hideInput()">取消</button>        </div>        </form>')}]),angular.module("directivesApp",[]).directive("pdfPlay",function(){return{replace:!0,transclude:!0,link:function(scope,ele){var kid=scope.knowledgeid;ele[0].getBoundingClientRect();scope.$watch("knowledgeFileUrl",function(newValue){function findDimensions(){window.innerWidth?winWidth=window.innerWidth:document.body&&document.body.clientWidth&&(winWidth=document.body.clientWidth),window.innerHeight?winHeight=window.innerHeight:document.body&&document.body.clientHeight&&(winHeight=document.body.clientHeight),document.documentElement&&document.documentElement.clientHeight&&document.documentElement.clientWidth&&(winHeight=document.documentElement.clientHeight,winWidth=document.documentElement.clientWidth)}function SetCookie(sName,sValue){date=new Date,s=date.getDate(),date.setDate(s+7),document.cookie=sName+"="+escape(sValue)+"; expires="+date.toGMTString()}function GetCookie(sName){for(var aCookie=document.cookie.split("; "),i=0;i<aCookie.length;i++){var aCrumb=aCookie[i].split("=");if(sName==aCrumb[0])return unescape(aCrumb[1])}return null}function renderPage(div,pdf,pageNumber,callback){-1==arr.indexOf(pageNumber)&&(arr.push(pageNumber),pdf.getPage(pageNumber).then(function(page){var scale=1;if(ifscale){var viewportmax=page.getViewport(scale);winWidth>viewportmax.width&&(scale=winWidth/viewportmax.width,ifscale=!1)}var viewport=page.getViewport(scale),pageDisplayWidth=viewport.width,pageDisplayHeight=viewport.height;if(1==pageNumber)for(var i=1;i<=pdf.numPages;i++){var pageDivHolder=document.createElement("div");pageDivHolder.id="pageContainer"+i,pageDivHolder.title="page"+i,pageDivHolder.style.margin="5px auto",pageDivHolder.style.backgroundColor="white",pageDivHolder.style.width=pageDisplayWidth+"px",pageDivHolder.style.height=pageDisplayHeight+"px",pageDivHolder.style.zoom=winWidth/pageDisplayWidth,div.appendChild(pageDivHolder),i==pdf.numPages&&(scope.$apply(function(){scope.Loading=!1}),pageheight=(pageDisplayHeight+5)*winWidth/pageDisplayWidth,document.body.scrollTop=GetCookie(kid))}var pageC="pageContainer"+pageNumber,canvas=document.createElement("canvas"),context=canvas.getContext("2d");canvas.width=pageDisplayWidth,canvas.height=pageDisplayHeight,document.getElementById(pageC).appendChild(canvas);var renderContext={canvasContext:context,viewport:viewport};page.render(renderContext).promise.then(callback)}))}function fnUnload(){SetCookie(kid,document.body.scrollTop)}function renderPageOne(pageNumber){pdfLoaderTask.then(function(pdf){pageNumber>pdf.numPages||0>=pageNumber||(arr.push(pageNumber),pdf.getPage(pageNumber).then(function(page){var scale=1,viewportmax=page.getViewport(scale);winWidth>viewportmax.width&&(scale=winWidth/viewportmax.width,ifscale=!1);var viewport=page.getViewport(scale),pageDisplayWidth=viewport.width,pageDisplayHeight=viewport.height,pageC="pageContainer"+pageNumber,canvas=document.createElement("canvas"),context=canvas.getContext("2d");canvas.width=pageDisplayWidth,canvas.height=pageDisplayHeight,document.getElementById(pageC).appendChild(canvas);var renderContext={canvasContext:context,viewport:viewport};page.render(renderContext).promise}))})}if("undefined"!=typeof newValue&&""!=newValue){var winHeight=0,winWidth=0,arr=new Array;findDimensions();var numPagesAll,pageheight=0,url=scope.knowledgeFileUrl,pdfWithFormsPath=url,ifscale=!0,pdfLoaderTask=PDFJS.getDocument(pdfWithFormsPath);pdfLoaderTask.then(function(pdf){var viewer=document.getElementById("viewer"),pageNumber=1;renderPage(viewer,pdf,pageNumber++,function pageRenderingComplete(){numPagesAll=pdf.numPages,pageNumber>pdf.numPages||(ifscale=!0,renderPage(viewer,pdf,pageNumber++,pageRenderingComplete))})});var pagelin=0;scope.pageindex=0,window.onscroll=function(){pagelin=Math.ceil((document.body.scrollTop+winHeight)/pageheight),pagelin>numPagesAll&&(pagelin=numPagesAll),0>=pagelin&&(pagelin=1);for(var pagepin=Math.ceil(winHeight/pageheight),i=0;pagepin>=i;i++)-1==arr.indexOf(pagelin-i)&&renderPageOne(pagelin-i);scope.pageindex<pagelin&&(scope.pageindex=pagelin)},window.onunload=fnUnload}})}}}).directive("dialog",function($timeout){return{restrict:"E",templateUrl:"views/common/dialog.html",replace:!0,link:function(scope,element){element.find("button").bind("click",function(){element.hide()})}}}).directive("hasDeleteItem",function(){return function(scope,ele){var flag=!1,deleteItem=$(ele[0]).find(".item-delete"),tItem=deleteItem.prev().get(0);touch.config.swipeMinDistance=10,touch.on(tItem,"swipeleft",function(e){var y=(-e.distanceX,Math.abs(e.distanceY));10>=y&&(tItem.style.transform="translateX(-60px)",tItem.style.webkitTransform="translateX(-60px)",flag=!0)}),$(tItem).on("touchstart",function(evt){flag&&(evt.preventDefault(),tItem.style.transform="translateX(0)",tItem.style.webkitTransform="translateX(0)",flag=!1)})}}).directive("focus",function($timeout){return{scope:{trigger:"@focus"},link:function(scope,element){scope.$watch("trigger",function(value){"true"===value&&$timeout(function(){element[0].focus()})})}}});
angular.module("filterApp",[]).filter("dateToString",function(){return function(text,format){if(angular.isNullOrEmpty(text))return"";text=text.replace(/\.\d+/,"").replace(/-/g,"/");var date=new Date(text);if(angular.isNullOrEmpty(date)||"Invalid Date"==date)return"";var dateStr=format;return dateStr=dateStr.replace("yyyy",date.getFullYear()).replace("MM",date.getMonth()+1<10?"0"+(date.getMonth()+1):date.getMonth()+1).replace("dd",date.getDate()<10?"0"+date.getDate():date.getDate()).replace("HH",date.getHours()<10?"0"+date.getHours():date.getHours()).replace("mm",date.getMinutes()<10?"0"+date.getMinutes():date.getMinutes()).replace("ss",date.getSeconds()<10?"0"+date.getSeconds():date.getSeconds()),dateStr=dateStr.replace("M",date.getMonth()+1).replace("d",date.getDate()).replace("H",date.getHours()).replace("m",date.getMinutes()).replace("s",date.getSeconds())}}).filter("parseStatus",function(){return function(index){var status={"-3":"输单","-2":"商机退回","-1":"线索退回",0:"未分配",1:"已分配",2:"初步洽谈",3:"需求确定",4:"方案/报价",5:"谈判审批",6:"赢单"};return status[index]}}).filter("parseRole",function(){return function(index){var status={0:"发起人",1:"使用者",2:"影响者",3:"守门人",4:"购买者",5:"决策者"};return status[index]}}).filter("parseSource",function(){return function(index){var array=["销售获取","市场活动","合作渠道","推广渠道","公司官网","公司微信","在线客服","产品注册","独立合伙人","老板关系","老客户转介绍","其他"];return array[index-1]}});